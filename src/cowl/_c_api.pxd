...
cdef extern from "cowl.h":
    ...
    CowlReader *cowl_reader_protocowl()
    const char *cowl_reader_get_name(CowlReader *reader)
    ...
    CowlWriter *cowl_writer_protocowl()
    int COWL_PROTOCOWL_INDEX_SIZE_UNBOUNDED
    void cowl_writer_protocowl_set_index_size(CowlWriter *writer, int index_size)
    void cowl_writer_protocowl_set_encode_anon(CowlWriter *writer, bint encode_anon)
    const char *cowl_writer_get_name(CowlWriter *writer)
