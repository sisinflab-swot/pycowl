...
class Annotation(Object, Annotated):
    def __init__(
        self,
...
class Ontology(Object, Annotated, HasIRI, PrimitiveFactory):
    @classmethod
...
class PrefixMap(Object, PrimitiveFactory):
    @staticmethod
