...
class Datatype(DataRange, Entity):
    ...
    def restricted_by(
        ...
        *restrictions: FacetRestriction,
        ...
        min_exclusive: Literal | LiteralValue | None = None,
        min_inclusive: Literal | LiteralValue | None = None,
        max_exclusive: Literal | LiteralValue | None = None,
        max_inclusive: Literal | LiteralValue | None = None,
